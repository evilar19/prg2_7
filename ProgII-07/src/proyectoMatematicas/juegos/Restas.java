...
public class Restas extends Juego implements Jugable{
	...
	public void jugar(Usuario usuario, ArrayList<Usuario> array) {
		...
		do {
			for (int i = 0; i < 10; i++) {
				...
				System.out.println("Se muestran la resta de estos dos numeros");
				...
				System.out.println("�Cual es el resultado de la resta? ");
	...
	public Restas(int times, int points){
		super();
		this.points = points;
		this.times = times;
	}
	
	public Restas(File file){
		super();
		this.file = file;
	}
